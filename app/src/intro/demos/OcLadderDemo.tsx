  ...
  return (
    <div>
      ...
      <div className="mt-4">
        ...
        <p className="mt-1 text-sm leading-relaxed text-gray-400">{tier.description}</p>
        ...
        <dl className="mt-3 space-y-2">
          <div>
            <dt className="text-sm tracking-wide text-gray-500 uppercase">Who</dt>
            <dd className="text-sm text-gray-300">{tier.typicalActors.join(" · ")}</dd>
          </div>
          <div>
            ...
            <dd className="mt-1 flex flex-wrap gap-1">
              {tier.keyCapabilities.map((c) => (
                <span
                  key={c}
                  className="rounded bg-gray-800 px-1.5 py-0.5 text-sm text-gray-300"
                >
                  {c}
                </span>
              ))}
