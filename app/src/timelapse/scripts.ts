...
export const SCRIPTS: TimeLapseScript[] = [
  ...
  },
  {
    ...
    annotations: [
      ...
      // Measured against the engine (OC4, neutral sliders): breach runs
      // 77.2% (2024) -> 63.4% (2026) -> 68.1% (2030). The baseline arrivals buy
      // 13.8pts and erosion gives back 4.7 of them, so this is a third, not a
      // half. Stated as a fraction rather than a figure because the point is the
      // shape -- gains land early, erosion is slower and never stops.
      { atYear: 2030, message: "Full AI capability. About a third of what the posture gained by 2026 has eroded away." },
    ],
  },
  {
    id: "current-state",
